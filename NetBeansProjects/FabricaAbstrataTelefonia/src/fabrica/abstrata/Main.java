...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*Fabrica Abstrata - Tem por função criar uma fabrica de
        ...
        * */
        ...
        /*Quando o envio é instanciado, será instanciado de acordo com a fábrica
        * que foi escolhida, portanto se foi escolhido uma fábrica da tim, somente
        * fábricas da tim podem ser instanciadas
        * */
